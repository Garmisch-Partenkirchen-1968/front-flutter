...
import 'package:test/components/home/home_body_popular_item.dart';
import 'package:test/size.dart';
import 'package:test/styles.dart';

class HomeBodySidebar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("project_1", style: h4(),),
          Text("project_2", style: h4(),),
          Text("project_3", style: h4(),),
          ],
        ),
